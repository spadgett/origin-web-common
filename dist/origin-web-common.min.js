...
_.each(e.resources, function(e) {
var t;
e.group ? (t = e.group, e.parentGroup = a.name, e.parentVersion = o) : t = a.name;
var r = e.version || o;
_.set(n, [ t, "versions", r, "resources", e.name ], e);
});
}).fail(function(e, t, n) {
r.push({
data: e,
...
var i;
if ((n = g(n)).group) {
if (!(i = _.get(t, [ "groups", n.group, "versions", n.version, "resources", n.resource ]))) return;
var s = _.get(t, [ "groups", n.group, "hostPrefix" ]) || t;
return {
resource: n.resource,
group: i.parentGroup || n.group,
version: i.parentVersion || n.version,
protocol: s.protocol,
hostPort: s.hostPort,
prefix: s.prefix,
...
var c;
for (var l in e) if (c = e[l], i = _.get(c, [ "resources", n.version, n.resource ])) return {
resource: n.resource,
version: n.version,
hostPort: c.hostPort,
prefix: c.prefix,
